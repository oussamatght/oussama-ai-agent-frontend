...
import { Send, Mic, MicOff, Settings, RotateCcw, Sparkles, User, Bot } from 'lucide-react';
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <motion.button
                ...
                className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 rounded-lg mt-4"
              >
                Done
              </motion.button>
            </div>
